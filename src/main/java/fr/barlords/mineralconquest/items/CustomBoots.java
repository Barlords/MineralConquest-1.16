...
public class CustomBoots extends CustomArmorEffects {

    public IArmorMaterial armorMaterial;

    public CustomBoots(IArmorMaterial materialIn, EquipmentSlotType slotIn, Properties properties) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip = addArmorInformation(tooltip, armorMaterial, 1);
    }
