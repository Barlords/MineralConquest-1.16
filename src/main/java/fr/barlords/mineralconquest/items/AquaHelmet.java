...
public class AquaHelmet extends CustomArmorEffects {
    public IArmorMaterial armorMaterial;

    public AquaHelmet(IArmorMaterial materialIn, EquipmentSlotType slotIn, Item.Properties properties) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(new StringTextComponent("\247eJe suis le protecteur des profondeurs."));
        if (InputMappings.isKeyDown(Minecraft.getInstance().getWindow().getWindow(), GLFW.GLFW_KEY_LEFT_SHIFT)) {
            tooltip.add(new StringTextComponent("\247e- Effet de Breathing X"));
