...
public class CustomChestplate extends CustomArmorEffects {

    public IArmorMaterial armorMaterial;

    public CustomChestplate(IArmorMaterial materialIn, EquipmentSlotType slotIn, Properties properties) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip = addArmorInformation(tooltip, armorMaterial, 3);
    }
