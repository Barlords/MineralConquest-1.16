...
public class CustomPickaxe extends PickaxeItem {
    ...
    public CustomPickaxe(IItemTier lTier, int attackDamageIn, float attackSpeedIn, Properties properties) {
    ...
    public boolean isFireResistant() {
        return tier == CustomToolTiers.BARLORITE || tier == CustomToolTiers.PURIUM;
    }

    /* permet de modifier la vitesse de minage
    @Override
