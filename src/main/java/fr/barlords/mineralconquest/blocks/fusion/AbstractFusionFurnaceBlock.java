...
public abstract class AbstractFusionFurnaceBlock extends ContainerBlock {
    public static final DirectionProperty FACING = HorizontalBlock.FACING;
    public static final BooleanProperty LIT = BlockStateProperties.LIT;

    public AbstractFusionFurnaceBlock(AbstractBlock.Properties properties) {
        super(properties);
    ...
    public void setPlacedBy(World p_180633_1_, BlockPos p_180633_2_, BlockState p_180633_3_, LivingEntity p_180633_4_, ItemStack p_180633_5_) {
        if (p_180633_5_.hasCustomHoverName()) {
            ...
            if (tileentity instanceof AbstractFusionFurnaceTileEntity) {
                ((AbstractFusionFurnaceTileEntity)tileentity).setCustomName(p_180633_5_.getHoverName());
            }
        }
    ...
    public void onRemove(BlockState p_196243_1_, World p_196243_2_, BlockPos p_196243_3_, BlockState p_196243_4_, boolean p_196243_5_) {
        if (!p_196243_1_.is(p_196243_4_.getBlock())) {
            ...
            if (tileentity instanceof AbstractFusionFurnaceTileEntity) {
                InventoryHelper.dropContents(p_196243_2_, p_196243_3_, (AbstractFusionFurnaceTileEntity)tileentity);
                ((AbstractFusionFurnaceTileEntity)tileentity).getRecipesToAwardAndPopExperience(p_196243_2_, Vector3d.atCenterOf(p_196243_3_));
